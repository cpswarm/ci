...
def main():
	...
	attackTreePeerModule.createConnection(andNode, attack1, diagram)
	attackTreePeerModule.createConnection(andNode, attack2, diagram)
	attackTreePeerModule.createConnection(andNode, attack3, diagram)
