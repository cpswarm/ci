...
def main():
	...
	attackTreePeerModule.updateReference(treeRef, "modelio_test_project/modelio_test_project/t09_Probability_Tag/t09_10_Propagate_Probability_Update_Ref_AND_Child_Other/Tree2")
	t.commit()
