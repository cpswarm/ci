...
def main():
	...
	testPackage = findPackage(modelPackage, "t09_Probability_Tag", "t09_02_Default_Probability_Attack")
	...
	if(attack.getName() != "Attack"):
		outputError("/errors_output/t09_02_Default_Probability_Attack.err", "Expected to find attack with the name 'Attack', instead we found the name " + attack.getName() + "\n")
	if attack.getTag("AttackTreeDesigner", "Attack", "Probability").getActual().get(0).getValue() != "MEDIUM" :
		outputError("/errors_output/t09_02_Default_Probability_Attack.err", "Expected to find Probability Tag with the value 'MEDIUM', instead we found the value " + attack.getTag("AttackTreeDesigner", "Attack", "Probability").getActual().get(0).getValue() + "\n")
