...
def main():
	...
	testPackage = findPackage(modelPackage, "t05_OR", "t05_05_Delete_OR")
	...
	if(not tree.getOwnedElement().isEmpty()):
		outputError("/errors_output/t05_05_Delete_OR.err", "Expected to find Root with no children \n")
