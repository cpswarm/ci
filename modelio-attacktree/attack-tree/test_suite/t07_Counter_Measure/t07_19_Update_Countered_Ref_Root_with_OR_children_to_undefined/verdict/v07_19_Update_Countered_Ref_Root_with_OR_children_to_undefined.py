...
def main():
	...
	# testPackage
	testPackage = findPackage(modelPackage, "t07_Counter_Measure", "t07_19_Update_Countered_Ref_Root_with_OR_children_to_undefined")
	...
	if tree.getTag("AttackTreeDesigner", "Attack", "Countered attack").getActual().get(0).getValue() != "false" :
		outputError("/errors_output/t07_19_Update_Countered_Ref_Root_with_OR_children_to_undefined.err", 
