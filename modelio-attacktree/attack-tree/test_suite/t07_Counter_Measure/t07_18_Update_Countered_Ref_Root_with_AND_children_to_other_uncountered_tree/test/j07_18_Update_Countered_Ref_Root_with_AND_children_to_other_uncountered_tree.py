...
def main():
	...
	# testPackage
	testPackage = findPackage(modelPackage, "t07_Counter_Measure", "t07_18_Update_Countered_Ref_Root_with_AND_children_to_other_uncountered_tree")
	...
	attackTreePeerModule.updateReference(treeReference, "modelio_test_project/modelio_test_project/t07_Counter_Measure/t07_18_Update_Countered_Ref_Root_with_AND_children_to_other_uncountered_tree/Tree2")
