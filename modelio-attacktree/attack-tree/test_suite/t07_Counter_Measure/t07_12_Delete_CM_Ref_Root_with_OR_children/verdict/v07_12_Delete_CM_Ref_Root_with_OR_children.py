...
def main():
	...
	if not attack1_Tree1.getDescriptor().isEmpty() :
		outputError("/errors_output/t07_12_Delete_CM_Ref_Root_with_OR_children.err", "Expected to find attack1_tree1 with no notes \n")


	# Verify Countered Tag value
	if tree.getTag("AttackTreeDesigner", "Attack", "Countered attack").getActual().get(0).getValue() != "false" :
		outputError("/errors_output/t07_12_Delete_CM_Ref_Root_with_OR_children.err", 
