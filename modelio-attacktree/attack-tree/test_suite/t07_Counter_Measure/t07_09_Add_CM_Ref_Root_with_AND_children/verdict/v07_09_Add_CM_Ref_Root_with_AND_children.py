...
def main():
	...
	if attack1_Tree1.getDescriptor().isEmpty() :
		outputError("/errors_output/t07_09_Add_CM_Ref_Root_with_AND_children.err", "Expected to find note  in attack1_tree1 \n")
	...
	if not (tree1Note.getModel().getName()=="Counter-Measure" and tree1Note.getContent()=="Counter-Measure"):
		outputError("/errors_output/t07_09_Add_CM_Ref_Root_with_AND_children.err", "Expected to find note with the name and content 'Counter-Measure', instead found name " + tree1Note.getModel().getName() + " and content " + tree1Note.getContent() + "\n")
