...
def main():
	...
	# testPackage
	testPackage = findPackage(modelPackage, "t07_Counter_Measure", "t07_24_Update_Undefined_Ref_to_countered_OR_Child")
	...
	attackTreePeerModule.updateReference(treeReference, "modelio_test_project/modelio_test_project/t07_Counter_Measure/t07_24_Update_Undefined_Ref_to_countered_OR_Child/Tree1")
