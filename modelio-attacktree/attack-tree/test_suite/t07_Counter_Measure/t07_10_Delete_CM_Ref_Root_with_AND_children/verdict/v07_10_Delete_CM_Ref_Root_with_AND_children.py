...
def main():
	...
	# testPackage
	testPackage = findPackage(modelPackage, "t07_Counter_Measure", "t07_10_Delete_CM_Ref_Root_with_AND_children")
	...
	if not attack1_Tree1.getDescriptor().isEmpty() :
		outputError("/errors_output/t07_10_Delete_CM_Ref_Root_with_AND_children.err", "Expected to find attack1_tree1 with no notes \n")


	# Verify Countered Tag value
	if tree.getTag("AttackTreeDesigner", "Attack", "Countered attack").getActual().get(0).getValue() != "false" :
		outputError("/errors_output/t07_10_Delete_CM_Ref_Root_with_AND_children.err", 
