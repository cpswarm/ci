...
def main():
	...
	t = session.createTransaction("import tree")
	attackTreePeerModule.importModel(testPackage, "/attack-tree/test_suite/t00_import/t00_02_import_tree/test/Tree1.xml")
	t.commit()
