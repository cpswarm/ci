...
def main():
	...
	t = session.createTransaction("import package")
	attackTreePeerModule.importModel(testPackage, "/attack-tree/test_suite/t00_import/t00_01_import_package/test/package")
	t.commit()
