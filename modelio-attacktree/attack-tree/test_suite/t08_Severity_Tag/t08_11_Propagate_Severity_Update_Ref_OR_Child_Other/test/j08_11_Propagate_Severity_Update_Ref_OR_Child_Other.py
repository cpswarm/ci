...
def main():
	...
	attackTreePeerModule.updateReference(treeRef, "modelio_test_project/modelio_test_project/t08_Severity_Tag/t08_11_Propagate_Severity_Update_Ref_OR_Child_Other/Tree2")
	t.commit()
